...
from ashare2026.config import ROOT, load_settings
...
def main(argv: list[str] | None = None) -> int:
    ...
    p_report.add_argument("-o", "--output", default=str(ROOT / "reports" / "daily.html"))
    ...
    if args.cmd == "serve":
        ...
        uvicorn.run("ashare2026.api.app:app", host=args.host, port=args.port, reload=False)
        return 0
    return 1
